...
type PageIssuePopoverProps = {
  issue: ResolvedCompletenessIssue | null;
...
export function PageIssuePopover({
  issue,
  workspaceRef,
  viewerRef,
  suggestionEdit,
  onClose,
}: PageIssuePopoverProps) {
  ...
  return (
    ...
    >
      ...
      <CompletenessCard issue={issue} active interactive={false} suggestionEdit={suggestionEdit} />
    </div>
  );
}
